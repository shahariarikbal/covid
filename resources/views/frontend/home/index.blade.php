   ...
   <div class="site-section stats">
     <div class="container">
          ...
          <div class="card">
               ...
               <div class="card-body">
                    <form action="{{ route('vaccine.register') }}" method="POST">
                         @csrf
                         <div class="row">
                              ...
                              <div class="col-lg-4 col-md-4">
                                   <div class="form-group">
                                        ...
                                        <input type="text" maxlength="15" name="nid" id="nid" value="{{ old('nid') }}" class="form-control" placeholder="Enter NID Number" />
                                        <span class="text-danger">{{ $errors->has('nid') ? $errors->first('nid') : ' ' }}</span>
                                   </div>
                              </div>
                              <div class="col-lg-4 col-md-4">
                                <div class="form-group">
                                     <label for="vaccine_date">Vaccine Date <span class="text-danger">*</span></label>
                                     <input type="date" name="vaccine_date" id="vaccine_date" value="{{ old('vaccine_date') }}" class="form-control" placeholder="Enter NID Number" />
                                     <span class="text-danger">{{ $errors->has('vaccine_date') ? $errors->first('vaccine_date') : ' ' }}</span>
                                </div>
                           </div>
                              <div class="col-lg-4 col-md-4">
                                   <div class="form-group">
                                        <label for="center_id">Vaccine Centers <span class="text-danger">*</span></label>
                                        <select class="form-control" name="center_id" id="center_id">
                                             ...
                                             @foreach ($vaccineCenters as $vaccineCenter)
                                                  <option value="{{ $vaccineCenter->id }}" {{ old('center_id') == $vaccineCenter->id ? 'selected' : '' }}>{{ $vaccineCenter->name }}</option>
                                             @endforeach
                                        </select>
                                        <span class="text-danger">{{ $errors->has('center_id') ? $errors->first('center_id') : ' ' }}</span>
                                   </div>
                              </div>
                              <div class="col-lg-6 col-md-6">
                                   <div class="form-group">
                                        <label for="email">E-mail <span class="text-danger">*</span></label>
                                        <input type="email" name="email" value="{{ old('email') }}" id="email" class="form-control" placeholder="Enter Emial" />
                              ...
                              <div class="col-lg-6 col-md-6">
                                   <div class="form-group">
                                        ...
                                        <input type="tel" name="phone" id="phone" value="{{ old('phone') }}" class="form-control" placeholder="Enter Phone Number" />
   ...
   <div class="site-section">
     <div class="container">
       ...
       <div class="row">
         ...
         <div class="col-lg-6">
           <img src="{{ asset('frontend/assets/') }}/images/protect.png" alt="Image" class="img-fluid">
         </div>
       </div>
     </div>
   </div>
       ...
       <div class="row">
         <div class="col-lg-6 mb-4">
           <div class="symptom d-flex">
             <div class="img">
               <img src="{{ asset('frontend/assets/') }}/images/symptom_high-fever.png" alt="Image" class="img-fluid">
             </div>
             <div class="text">
               <h3>High Fever</h3>
         ...
         <div class="col-lg-6 mb-4">
           <div class="symptom d-flex">
             <div class="img">
               <img src="{{ asset('frontend/assets/') }}/images/symptom_cough.png" alt="Image" class="img-fluid">
             </div>
             <div class="text">
               <h3>Cough</h3>
         ...
         <div class="col-lg-6 mb-4">
           <div class="symptom d-flex">
             <div class="img">
               <img src="{{ asset('frontend/assets/') }}/images/symptom_sore-troath.png" alt="Image" class="img-fluid">
             </div>
             <div class="text">
               <h3>Sore Troath</h3>
         ...
         <div class="col-lg-6 mb-4">
           <div class="symptom d-flex">
             <div class="img">
               <img src="{{ asset('frontend/assets/') }}/images/symptom_headache.png" alt="Image" class="img-fluid">
             </div>
             <div class="text">
               <h3>Headache</h3>
